...
class ExtractorTests(unittest.TestCase):
    ...
    def test_identifies_narrative_tables_vs_financial_matrices(self):
        """Ensure narrative explanatory tables are kept while numeric tables are dropped."""
        narrative_rows = (
            ("The critical audit matter communicated below is an area of significant auditor judgment in the current audit period.",),
            ("How our audit addressed the matter: We tested internal controls over financial reporting.",),
        )
        self.assertTrue(is_narrative_table(narrative_rows))

        matrix_rows = (
            ("Assets", "2024", "2023"),
            ("Cash and cash equivalents", "$ 1,234", "$ 1,100"),
            ("Total loans and leases", "$ 5,678", "$ 5,400"),
        )
        self.assertFalse(is_narrative_table(matrix_rows))
